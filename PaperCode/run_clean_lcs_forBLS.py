...
'''
PURPOSE: cleans raw lcs & saves them DIFFERENT from run_clean_lcs.py b/c no lower outlier
	removal in order to preserve transit bottoms
...
save_path = externalpath + 'Final_Run/Clean_LCs_forBLS/'
